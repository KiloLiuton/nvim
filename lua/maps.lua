...
map('i', '<C-l>', function() return escapePair() end)
...
local function setup_buffer_keymaps(bufnr)
    ...
    wk.register({
        l = {
            ...
            f = { function() vim.lsp.buf.format({ async = true }) print('Buffer formatted!') end, 'Format' },
...
vim.api.nvim_create_autocmd('LspAttach', { callback = function(args) setup_buffer_keymaps(args.buf) end })
